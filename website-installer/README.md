...
Die Website läuft, solange das (minimierte) PowerShell-Fenster in der Taskleiste
...
`build.py` packt `install.ps1` samt `server.ps1`, `admin.html`, `start.html` und
`uninstall.ps1` (Base64) in `Website-Installer.bat`.
