...
4) TESTS
   ...
   Erwartung: 641 Tests, alle grün oder übersprungen (bis zu 28 werden
   übersprungen, wenn ffmpeg/ffprobe/tesseract/nginx fehlen oder kein
   Docker-Daemon läuft -- das ist kein Fehler, nur ein fehlendes optionales
   Programm). Kommt irgendetwas als FAILED heraus, zeig mir die Ausgabe — ich will die Zahl
